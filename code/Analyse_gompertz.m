...
p1(2).String = sprintf('%s\n(%.1f%%)',p1(2).String, x1(1)/sum(x1)*100); 
p1(4).String = sprintf('%s\n(%.1f%%)',p1(4).String, x1(2)/sum(x1)*100); 
p1(6).String = sprintf('%s\n(%.1f%%)',p1(6).String, x1(3)/sum(x1)*100); 
...
annotation(gcf,'textbox',[0.355271085832472 0.927031509121062 0.314842668045501 0.04638],...
